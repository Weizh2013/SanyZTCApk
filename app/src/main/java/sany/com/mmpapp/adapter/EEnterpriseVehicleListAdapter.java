 ...
 */
public class EEnterpriseVehicleListAdapter extends BaseExpandableListAdapter {
    private EnterpriseMainActivity mMainActivity ;//必须要传进来
    private List<Enterprise> enterpriseList=null;
    private List<Vehicle> vehicleList=null;
    private Context ctx;
    public EEnterpriseVehicleListAdapter(List<Enterprise> groupList, List<Vehicle> childList, Context ctx, EnterpriseMainActivity mMainActivity){
