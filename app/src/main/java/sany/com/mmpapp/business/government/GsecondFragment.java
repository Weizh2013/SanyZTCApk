...
import sany.com.mmpapp.adapter.GEnterpriseVehicleListAdapter;
 ...
 */
public class GsecondFragment extends Fragment implements AMap.InfoWindowAdapter, AMap.OnMarkerClickListener, AMap.OnInfoWindowClickListener {
    ...
    private GEnterpriseVehicleListAdapter GEnterpriseVehicleListAdapter;
            ...
            switch (msg.what) {
                case Http.SIG_GOOD:
                    try {
                        ...
                        GEnterpriseVehicleListAdapter = new GEnterpriseVehicleListAdapter(groupList, childList, mMainActivity.getApplicationContext(), mMainActivity);
                        elv_enterpriseVehicle.setAdapter(GEnterpriseVehicleListAdapter);
                        ...
                        elv_enterpriseVehicle.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
                            ...
                            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                                ...
                                mDrawer.animateOpen();
                                clickVehicle = (Vehicle) GEnterpriseVehicleListAdapter.getChild(groupPosition, childPosition);
                                //查询数据，并在地图上打点
    ...
    public View getInfoWindow(Marker marker) {
        ...
        img_CloseWindow.setOnClickListener(new InfoWindowBtnClickListener(
                marker));
    ...
    public void onInfoWindowClick(Marker marker) {
        // marker.showInfoWindow();
        //Toast.makeText(mMainActivity, "this", Toast.LENGTH_SHORT).show();
    }
